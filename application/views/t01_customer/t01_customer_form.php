    ...
    <form action="<?php echo $action; ?>" method="post" class="card">
        ...
        <div class="card-body col-6">
            ...
            <div class="mb-3 row">
                ...
                <div class="col">
                    <input type="text" class="form-control" name="rentang_waktu" id="rentang_waktu" placeholder="Rentang Waktu" value="<?= $rentang_waktu ?>" />
                    <small class="form-hint"><?= form_error('rentang_waktu') ?></small>
                </div>
            </div>
        ...
        <div class="card-footer text-start">
            ...
            <a href="<?= site_url('t01_customer') ?>" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
