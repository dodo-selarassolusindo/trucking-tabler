...
class T00_lokasi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 't00_lokasi?q=' . urlencode($q);
            $config['first_url'] = base_url() . 't00_lokasi?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 't00_lokasi';
            $config['first_url'] = base_url() . 't00_lokasi';
        }
        ...
        $data = array(
            't00_lokasi_data' => $t00_lokasi,
            'q' => $q,
            'pagination' => $this->pagination->create_links(),
            'total_rows' => $config['total_rows'],
            'start' => $start,
        );
        // $this->load->view('t00_lokasi/t00_lokasi_list', $data);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2024-01-31 10:25:43 */
/* http://harviacode.com */