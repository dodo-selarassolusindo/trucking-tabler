        ...
        <div class="card-body">
            ...
            <div class="row" style="margin-bottom: 10px">
                <div class="col-md-4 text-start">
                    <?php echo anchor(site_url('t06_cost/create'), 'Create', 'class="btn btn-primary"'); ?>
                    <?php echo anchor(site_url('t06_cost/excel'), 'Excel', 'class="btn btn-primary"'); ?>
                </div>
