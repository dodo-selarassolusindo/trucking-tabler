        ...
        <div class="card-body">
            ...
            <div class="row" style="margin-bottom: 10px">
                <div class="col-md-4 text-start">
                    <?php echo anchor(site_url('t30_job_order/create'), 'Create', 'class="btn btn-primary"'); ?>
                    <?php echo anchor(site_url('t30_job_order/excel'), 'Excel', 'class="btn btn-primary"'); ?>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = new DataTable('#example', {
            ajax: '<?= site_url()."t30_job_order/json2" ?>',
            processing: true,
            serverSide: true,
            columnDefs: [
